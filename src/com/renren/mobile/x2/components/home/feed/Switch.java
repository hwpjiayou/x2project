...
//       // mThumbDrawable = getContext().getResources().getDrawable(R.drawable.ic_launcher);
//        mTrackDrawable = a.getDrawable(R.styleable.Switch_track);
        //mTrackDrawable = getContext().getResources().getDrawable(R.drawable.ic_launcher);
...
//        }
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TypedArray appearance = context.obtainStyledAttributes(resid, null);
        ...
        typefaceIndex = appearance.getInt(0, -1);
        styleIndex = appearance.getInt(0, -1);
