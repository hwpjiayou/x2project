 ...
 * */
public interface ChatHistory_Column extends DatabaseColumn{
	
	@Column(defineType=com.renren.mobile.x2.core.db.DatabaseTypeConstant.INT+" "+com.renren.mobile.x2.core.db.DatabaseTypeConstant.PRIMARY)
	...
	@Column(defineType=DatabaseTypeConstant.INT)
	public final String IS_BRUSH ="is_brush";//是否来自毛笔字
