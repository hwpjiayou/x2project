...
public class ChineseToPinyinResource {
	...
	private void initializeResource() {
		try {
			final String resourceName = "pinyindb/unicode_to_hanyu_pinyin.properties";
	...
	private boolean isValidRecord(String record) {
		...
		if ((null != record) && !record.equals(noneStr) && record.startsWith(Field.LEFT_BRACKET) && record.endsWith(Field.RIGHT_BRACKET)) {
			return true;
		} else
			return false;
	}
	...
	static ChineseToPinyinResource getInstance() {
		if (ChineseToPinyinResourceHolder.theInstance == null) {
			ChineseToPinyinResourceHolder.theInstance = new ChineseToPinyinResource();
		}
	...
	private static class ChineseToPinyinResourceHolder {
		static ChineseToPinyinResource theInstance = new ChineseToPinyinResource();
	}

	public static void clearInstance() {
		if (ChineseToPinyinResourceHolder.theInstance != null) {
			ChineseToPinyinResourceHolder.theInstance = null;
		}
	}
