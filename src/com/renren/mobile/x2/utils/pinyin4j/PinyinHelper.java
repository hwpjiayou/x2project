...
public class PinyinHelper {
	 ...
	 * <p>
	 * For example, <br/>
	 * If the input is '间', the return will be an array with two Hanyu Pinyin
	 * strings: <br/>
	 * "jian1" <br/>
	 * "jian4" <br/>
	 * <br/>
	 * If the input is '李', the return will be an array with single Hanyu Pinyin
	 * string: <br/>
	 * "li3"
	 * 
	 * <p>
	 ...
	 */
	static private String[] getFormattedHanyuPinyinStringArray(char ch, HanyuPinyinOutputFormat outputFormat) throws BadHanyuPinyinOutputFormatCombination {
	...
	static public String[] toTongyongPinyinStringArray(char ch) {
		// return convertToTargetPinyinStringArray(ch,
	...
	// getUnformattedHanyuPinyinStringArray(ch);
	//
	// if (null != hanyuPinyinStringArray)
	// {
	// String[] targetPinyinStringArray = new
	// String[hanyuPinyinStringArray.length];
	//
	 ...
	 */
	static public String toHanyuPinyinString(String str, HanyuPinyinOutputFormat outputFormat, String seperater) throws BadHanyuPinyinOutputFormatCombination {
	 ...
	 */
	static private String getFirstHanyuPinyinString(char ch, HanyuPinyinOutputFormat outputFormat) throws BadHanyuPinyinOutputFormatCombination {
